...
/* package Tron-Game-0.1.0.0 */
#ifndef VERSION_Tron_Game
#define VERSION_Tron_Game "0.1.0.0"
#endif /* VERSION_Tron_Game */
#ifndef MIN_VERSION_Tron_Game
#define MIN_VERSION_Tron_Game(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_Tron_Game */
...
#define CURRENT_COMPONENT_ID "Tron-Game-0.1.0.0-inplace-Tron-Game"
